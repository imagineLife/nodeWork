...
5. when done, control-c the running node server, the first terminal window that ran node index.js
 ...
 in terminal, curl localhost:3000/micCheck?TextQueryString=TestQSEqual
 returns...
 request recieved on micCheck with method get & queryStringParams Next...
{ TextQueryString: 'TestQSEqual' }
